...
def llm_analyze_superclass(file_path: str, method_code: str, invocation_code: str) -> list[LLMChunk]:
    ...
    return [
        LLMChunk(file_path, ChunkType.PARENT_FILE_SUMMARY, run_llm(parent_file_system_prompt, parent_file_user_prompt, {"code": full_code})),
        LLMChunk(file_path, ChunkType.PARENT_METHOD_SUMMARY, run_llm(parent_method_system_prompt, parent_method_user_prompt, {"code": method_code})),
        LLMChunk(file_path, ChunkType.INVOCATION_SUMMARY, run_llm(invocation_system_prompt, invocation_user_prompt, {"code": invocation_code}))
    ]
...
def llm_analyze_subclass(file_path: str, method_code: str) -> list[LLMChunk]:
    ...
    return [
        LLMChunk(file_path, ChunkType.CHILD_FILE_SUMMARY, run_llm(child_file_system_prompt, child_file_user_prompt, {"code": full_code})),
        LLMChunk(file_path, ChunkType.CHILD_METHOD_SUMMARY, run_llm(child_method_system_prompt, child_method_user_prompt, {"code": method_code}))
    ]
